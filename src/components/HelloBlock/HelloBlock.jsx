            ...
            <HelloText>
                <ul>
                    ...
                    <ShowTextStyled toShow={toShow}>
                        ...
                        <p>
                            Я родилась в маленьком городе в Рязанской области. Было время, когда я жила в жуткой нищете в бараке. Когда я выросла - моя самооценка была разрушена полностью , а вера в то, что я когда-то смогу выбраться из нищеты просто отсутствовала...
                            А ещё мне совсем не на кого было надеяться, тк я с детства не жила с родителями (да и там надеяться тоже не на кого)
                        </p>
                    </ShowTextStyled>
                    <ShowTextStyled toShow={toShow}>
                        <div>
