...
import { contentTypeMeditation } from '../CatalogWrapper/CatalogWrapper';
import {
    CatalogCardCoast,
        ...
        <PopupCardpayWrapper onClick={() => setShowPopup(false)}>
            <CatalogCardWrapper>
                <form onClick={(e) => e.stopPropagation()}>
                    ...
                    {coastStrike && <CatalogCardCoastStrike>{coastStrike} ₽</CatalogCardCoastStrike>}
                    <div>
                        <label name='phone'>Ваш телефон:</label>
                        <input name='phone' type='phone' value={phone} onChange={(e) => setPhone(e.target.value)} required/>
                    </div>
                    <div>
