export const getPaylink = (order_id, customer_phone, customer_email, products, paid_content) => {
  ...
  let paidContent = `paid_content=test_develop_content&`; // test develop ${paid_content}
  let urlSuccess = `urlSuccess=https://develop.astrologdemidova.ru/fortuna?cust_email=${customer_email}&cust_phone=${customer_phone}&`;
  let dO = `do=pay`
