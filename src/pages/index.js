...
const IndexPage = () => {
    ...
    return (
        <>
            ...
            <LineHeader bgColor="white">Откровенно обо мне :</LineHeader>

            <HelloBlock />

            <LineHeader bgColor="white" />
            <LineHeader bgColor="blue">Главные секреты финансового изобилия</LineHeader>

            <Element name="reason"></Element>
            <LineHeader bgColor="white">ВАМ НУЖЕН МАРАФОН, ЕСЛИ ВЫ</LineHeader>

            <ReasonsBlock />

            <LineHeader bgColor="white" />
            <LineHeader bgColor="white">НА МАРАФОНЕ вы:</LineHeader>

            <MarathonBlock />

            <LineHeader bgColor="white" />
            <Element name="program"></Element>
            <LineHeader bgColor="white">ПРОГРАММА МАРАФОНА</LineHeader>
            ...
            <LineHeader bgColor="white">Какой результат вы получите?</LineHeader>

            <ResultBlock />

            <Element name="review"></Element>
            <LineHeader bgColor="white">ОТЗЫВЫ</LineHeader>

            <ReviewsBlock />

            <LineHeader bgColor="white">ПРИЗЫ</LineHeader>
            <GiftsBlock />

            <Element name="tariff"></Element>
            <LineHeader bgColor="white">
                до поднятия цен:&nbsp;
                <Moment date={moment('2021-06-20 22:38:00')} format={"hh:mm:ss"} durationFromNow interval={1000}></Moment>
            </LineHeader>
            <LineHeader bgColor="white">
                ТАРИФЫ
                <br />
            ...
            <LineHeader bgColor="white" smallFont={true}>
                НАПИШИТЕ НАМ И МЫ С РАДОСТЬЮ ОТВЕТИМ НА ВСЕ ВАШИ ВОПРОСЫ И ПОМОЖЕМ ВАМ ОПРЕДЕЛИТЬСЯ
                С ТАРИФОМ!
            </LineHeader>
            <LineHeader bgColor="white">
          ...
          ЗАДАТЬ ВОПРОС
                ...
                <a href={'https://wa.me/message/JSDOINY2LABTP1'} rel="noreferrer" target="_blank">
                    <CustomButton>ЗАДАТЬ ВОПРОС</CustomButton>
                </a>
            </LineHeader>
